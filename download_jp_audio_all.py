...
for id_row, content_row in jp_650.iterrows():
    ...
    working_dir = Path('jp_audio') / str(id_row+1)
    ...
    with open(working_dir / 'jp_audio.log', 'w') as log_file:
        subprocess.run(['python', '/home/zguo/Projects/jpzh_music/download_jp_audio.py', search_term], cwd=working_dir, stdout=sys.stdout, stderr=log_file)